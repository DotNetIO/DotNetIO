...
namespace DotNetIO
{
	...
	public static class FileExtensions
	{
		...
		public static Stream OpenAppend(this File file)
		{
			Contract.Requires(file != null);
			Contract.Ensures(Contract.Result<Stream>() != null);
		...
		public static string ReadAllText(this File file)
		{
			Contract.Requires(file != null);
		...
		public static void WriteAllText(this File file, string contents)
		{
			Contract.Requires(file != null);
